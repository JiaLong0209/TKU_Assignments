...
def train(args):
    ...
    log_path = "output/adapter_log.jsonl"
    ...
    try:
        ...
        os.makedirs("checkpoints/adapter", exist_ok=True)
        ckpt = f"checkpoints/adapter/{args.mode}_interrupted.pt"
    ...
    os.makedirs("checkpoints/adapter", exist_ok=True)
    ckpt = f"checkpoints/adapter/{args.mode}_epoch{args.epochs:02d}.pt"
